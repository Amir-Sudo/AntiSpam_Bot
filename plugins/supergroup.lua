...
local title ="📝اطـلاعـات سـوپـرگـروه📝: ["..result.title.."]\n\n"
local admin_num = "ادمـین های سـوپـرگـروه: "..result.admins_count.."\n"
local user_num = "تـعـداد مـمـبـرهـا: "..result.participants_count.."\n"
local kicked_num = "افـراد بـن شـده: "..result.kicked_count.."\n"
local channel_id = "🆔ایـدی سـوپـرگـروه: "..result.peer_id.."\n"
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    return '🔐قـفـل لـیـنڪ در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_link'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل لـنـڪ در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  if group_link_lock == 'no' then
    return '🔓قـفـل لـیـنـڪ در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_link'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل لـیـنـڪ در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'yes' then
    return '🔐قـفـل اسـپـم در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_spam'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل اسـپـم در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    return '🔓قـفـل اسـپـم در سـوپرگـروه از قـبـل غـیـرفـعـال بود🔓'
  else
    data[tostring(target)]['settings']['lock_spam'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل اسـپـم در سـوپـرگـروه غـیـرفـعـال شد🔓'
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    return '🔐قـفـل حـسـاسـیـت بـہ اسـپـم در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['flood'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل حـسـاسـیت بـہ اسـپـم در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    return '🔓قـفـل حـسـاسـیت بـہ اسـپـم در سـوپـرگـروه از قـبـل غـیـرفـعـال بود🔓'
  else
    data[tostring(target)]['settings']['flood'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل حـسـاسـیت بـہ اسـپـم در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    return '🔐قـفـل فـارسـے و عـربـے در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل فـارسـے و عـربـے در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    return '🔓قـفـل فـارسـے و عـربـے در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل فـارسـے و عـربـے در سـوپـرگـروه غـیـرفـعـال شد🔓'
  end
end
...
local function lock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'yes' then
    return '🔐قـفـل اعـضـا در سـوپـرگـروه از قــبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_member'] = 'yes'
    save_data(_config.moderation.data, data)
  end
  return '🔐قـفـل اعـضـا در سـوپـرگـروه فـعـال شـد🔒'
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    return '🔓قـفـل اعـضـا در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_member'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل اعـضـا در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    return '🔐قـفـل کـاراڪـتـر هـای غـیـرمـجـاز در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل کـاراڪـتـر هـای غـیـرمـجـاز در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    return '🔓قـفـل کـاراڪـتـر هـای غـیـرمـجـاز در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل کـاراڪـتـر هـای غـیـرمـجـاز در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    return '🔐قـفـل اسـتـیـڪـر در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل اسـتـیـڪـر در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    return '🔓قـفـل اسـتـیـڪـر در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل اسـتـیـڪـر در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    return '🔐قـفـل کـانـتـڪت در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل کـانـتـڪت در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    return '🔓قـفـل کـانـتـڪت در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل کـانـتـڪت در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'yes' then
    return '🔐قـفـل امـوجـے در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_emoji'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل امـوجـے در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'no' then
    return '🔓قـفـل امـوجـے در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_emoji'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل امـوجـے در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_english(msg, data, target)
  ...
  if group_english_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return '🔐قـفـل انـگـلیـسـے در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_english(msg, data, target)
  ...
  if group_english_lock == 'no' then
    return '🔓قـفـل انـگـلیـسـے در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_english'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل انـگـلیـسـے در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_file(msg, data, target)
  ...
  if group_file_lock == 'yes' then
    return '🔐قـفـل فـایـل در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_file'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل فـایـل در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_file(msg, data, target)
  ...
  if group_file_lock == 'no' then
    return '🔓قـفـل فـایـل در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
...
local function unlock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'no' then
    return '🔓قـفـل فـوروارد در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
...
local function unlock_group_fosh(msg, data, target)
  ...
  if group_fosh_lock == 'no' then
    return '🔓قـفـل فـحـش در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_fosh'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل فـحـش در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_audio(msg, data, target)
  ...
  if group_audio_lock == 'yes' then
    return '🔐قـفـل ویـس در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_audio'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل ویـس در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_audio(msg, data, target)
  ...
  if group_audio_lock == 'no' then
    return '🔓قـفـل ویـس در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_audio'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل ویـس در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_video(msg, data, target)
  ...
  if group_video_lock == 'yes' then
    return '🔐قـفـل فـیـلـم در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_video'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل فـیـلـم در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_video(msg, data, target)
  ...
  if group_video_lock == 'no' then
    return '🔓قـفـل فـیـلـم در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_video'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل فـیـلـم در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_photo(msg, data, target)
  ...
  if group_photo_lock == 'yes' then
    return '🔐قـفـل عـڪـس در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_photo'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل عـڪـس در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_photo(msg, data, target)
  ...
  if group_photo_lock == 'no' then
    return '🔓قـفـل عـڪـس در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_photo'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل عـڪـس در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_number(msg, data, target)
  ...
  if group_number_lock == 'yes' then
    return '🔐قـفـل شـمـارہ در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_number'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل شـمـارہ در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_number(msg, data, target)
  ...
  if group_number_lock == 'no' then
    return '🔓قـفـل شـمـارہ در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_number'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل شـمـارہ در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_hashtag(msg, data, target)
  ...
  if group_hashtag_lock == 'yes' then
    return '🔐قـفـل هـشـتـگ(#) در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_hashtag'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل هـشـتـگ(#) در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_hashtag(msg, data, target)
  ...
  if group_hashtag_lock == 'no' then
    return '🔓قـفـل هـشـتـگ(#) در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_hashtag'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل هـشـتـگ(#) در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'yes' then
    return '🔐قـفـل شـارژ در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_operator'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل شـارژ در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'no' then
    return '🔓قـفـل شـارژ در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_operator'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل شـارژ در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_username(msg, data, target)
  ...
  if group_username_lock == 'yes' then
    return '??🔐قـفـل آیـدے(@) در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_username'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل آیـدے(@) در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_username(msg, data, target)
  ...
  if group_username_lock == 'no' then
    return '🔓قـفـل آیـدے(@) در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_username'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل آیـدے(@) در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function lock_group_commands(msg, data, target)
  ...
  if group_commands_lock == 'yes' then
    return '🔐قـفـل "!" و "/" و "#" در سـوپـرگـروه از قـبـل فـعـال بـود🔒'
  else
    data[tostring(target)]['settings']['lock_commands'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐قـفـل "!" و "/" و "#" در سـوپـرگـروه فـعـال شـد🔒'
  end
end
...
local function unlock_group_commands(msg, data, target)
  ...
  if group_commands_lock == 'no' then
    return '🔓قـفـل "!" و "/" و "#" در سـوپـرگـروه از قـبـل غـیـرفـعـال بـود🔓'
  else
    data[tostring(target)]['settings']['lock_commands'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔓قـفـل "!" و "/" و "#" در سـوپـرگـروه غـیـرفـعـال شـد🔓'
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    return '🔥تنظیمات سخت گیرانه از قبل فعال بود🔥'
  else
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    return '🔥تنظیمات سخت گیرانه از قبل فعال نبود🔥'
  else
...
local function demote_admin(receiver, member_username, user_id)
  ...
  if not data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_tag_username..' ادمین نیست')
  end
...
local function promote2(receiver, member_username, user_id)
  ...
  local member_tag_username = string.gsub(member_username, '@', '(at)')
  if not data[group] then
    return send_large_msg(receiver, 'سوپرگروه ادد نیست')
  end
  if data[group]['moderators'][tostring(user_id)] then
...
local function demote2(receiver, member_username, user_id)
  ...
  data[group]['moderators'][tostring(user_id)] = nil
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username..' از ادمینی حذف شد')
end
...
local function modlist(msg)
  ...
  if not data[tostring(groups)][tostring(msg.to.id)] then
    return '🔥سوپرگروه ادد شده نیست🔥'
  end
  -- determine if table is empty
  if next(data[tostring(msg.to.id)]['moderators']) == nil then
    return '🔥هیچ مدیری تو گروه نیست🔥'
  end
  local i = 1
...
function get_message_callback(extra, success, result)
    ...
    if member_id == msg.from.id then
      return send_large_msg("channel#id"..channel_id, "برای خارج شدن از دستور\nkickmeاستفاده کن
    end
    if is_momod2(member_id, channel_id) and not is_admin2(msg.from.id) then
			   return send_large_msg("channel#id"..channel_id, "تو فقط میتونی ادمینو مدیرو اونرو حذف کنی.")
    end
    if is_admin2(member_id) then
         return send_large_msg("channel#id"..channel_id, "تو میتونی ادمین های دیگه رو حذف کنی.")
    end
		...
		if vusername == member or vpeer_id == memberid then
			...
			if group_owner then
				...
				if result.username then
					...
					text = "["..v.peer_id.."] 👤به عنوان صاحب سوپرگروه افزوده شد"
				end
			end
	...
	local data = load_data(_config.moderation.data)
		if matches[1] == 'add' and not matches[2] then
			...
			if is_super_group(msg) then
				return reply_msg(msg.id, 'پـاور اسـپـیـد در سـوپـرگـروه فـعـال شـد.', ok_cb, false)
			end
		...
		if matches[1] == 'rem' and is_admin1(msg) and not matches[2] then
			if not is_super_group(msg) then
				return reply_msg(msg.id, 'پـاوراسـپـیـد در سـوپـرگـروه غـیـرفـعـال شـد.', ok_cb, false)
			end
		...
		if matches[1] == 'id' then
			...
			elseif msg.text:match("@[%a%d]") then
				...
				return "*⃣آیدے سوپر گروه :\n["..msg.to.id.."]\nℹ️ نام سوپر گروه :\n["..msg.to.title.."]\n▶️ نام شما :\n["..(msg.from.first_name or 'موجود نیست !').."]\n#⃣ فامیلی شما :\n["..(msg.from.last_name or 'وجود نیست!'.."]\n🔁 شناسه ی شما<\n["..msg.from.id.."]\n⏺ یوزر نیم شما :\n[ @"..(msg.from.username or 'وجود نیست !").." ]\n🔼 لینک شما : de>\n[  Telegram.Me/"..(msg.from.username or 'موجود نیست !').." ]"
			end
		end
		...
		if matches[1] == 'newlink' and is_momod(msg)then
			...
			local receiver = get_receiver(msg)
				if success == 0 then
					...
					send_large_msg(receiver, "🔁لـیـنـڪ جـدیـد سـاخـتـہ شـد")
		...
		if matches[1] == 'setlink' and is_owner(msg) then
			...
			save_data(_config.moderation.data, data)
			return 'ℹلـیـنـڪ جـدیـد را ارسـال کـنـیـد'
		end
		...
		if matches[1] == 'link' then
			...
			return "🌐لـیـنـڪ ورود بـہ سـوپـرگـروه🚀:\n"..group_link
		end
		...
		if matches[1] == 'demote' then
			...
			if not is_owner(msg) then
				return "trx h,kv , s,n, ldj,hkkn lndv ;kkn"
			end
			if type(msg.reply_id) ~= "nil" then
				local cbreply_extra = {
					get_cmd = 'demote',
		...
		if matches[1] == "setabout" and is_momod(msg) then
			...
			save_data(_config.moderation.data, data)
			savelog(msg.to.id, name_log.." ["..msg.from.id.."] موضوع گروه انتخاب شد به\n "..about_text)
		...
		if matches[1] == 'setrules' and is_momod(msg) then
			rules = matches[2]
			local target = msg.to.id
			savelog(msg.to.id, name_log.." ["..msg.from.id.."] قوانین گروه انتخاب شد به\n ["..matches[2].."]")
			return set_rulesmod(msg, data, target)
		end

		if msg.media then
			if msg.media.type == 'photo' and data[tostring(msg.to.id)]['settings']['set_photo'] == 'waiting' and is_momod(msg) then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] عکس جدید انتخاب شد")
		...
		if matches[1] == 'clean' then
			...
			if matches[2] == 'modlist' then
				...
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] امدیران گروه پاک شد")
			...
			if matches[2] == 'rules' then
				...
				save_data(_config.moderation.data, data)
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] قوانین گروه پاک شد")
			...
			if matches[2] == 'about' then
				...
				data[tostring(msg.to.id)][data_cat] = nil
				save_data(_config.moderation.data, data)
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] درباره ی گروه پاک شد")
				channel_set_about(receiver, about_text, ok_cb, false)
		...
		if matches[1] == 'unlock' and is_momod(msg) then
			...
			if matches[2] == 'file' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] unlocked file actions")
			...
			if matches[2] == 'photo' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] unlocked photo actions")
				return unlock_group_photo(msg, data, target)
			end
			if matches[2] == 'number' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] unlocked number actions")
				return unlock_group_number(msg, data, target)
			end
			if matches[2] == 'hashtag' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] unlocked hashtag posting")
				return unlock_group_hashtag(msg, data, target)
			end
			if matches[2] == 'operator' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] unlocked operator actions")
			...
			if matches[2] == 'commands' then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] unlocked commands actions")
		...
		if matches[1] == 'setflood' then
			...
			if tonumber(matches[2]) < 5 or tonumber(matches[2]) > 20 then
				return "تو فقط میتونی از5تا20 رو انتخاب کنی"
			end
			local flood_max = matches[2]
			data[tostring(msg.to.id)]['settings']['flood_msg_max'] = flood_max
			save_data(_config.moderation.data, data)
			savelog(msg.to.id, name_log.." ["..msg.from.id.."] set flood to ["..matches[2].."]")
			return 'انتخاب شد به: '..matches[2]
		end
		...
		if matches[1] == 'help' and not is_momod(msg) then
			text = "بـرای دریـافـتـہ دسـتـورات فارسـیـہ پـاور اسـپـیـد به کـانـال @PowerSpeed_ch مـراجـعـہ ڪـنـیـد."
